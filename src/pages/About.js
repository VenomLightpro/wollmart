              ...
              <div className="accordion accordion-simple accordion-plus">
                <div className="card border-no">
                  <div className="card-header">
                    <a href="about-us.html#collapse3-1" className="collapse">
                      Customer Service
                    </a>
                  </div>
                  <div className="card-body expanded" id="collapse3-1">
                    <p className="mb-0">
                      ...
                      dolore magna aliqua. Venenatis tell us in metus vulputate
                      eu scelerisque felis. Vel pretium vulp.
                    </p>
                  </div>
                </div>
                <div className="card">
                  <div className="card-header">
                    <a href="about-us.html#collapse3-2" className="expand">
                      Online Consultation
                    </a>
                  </div>
                ...
                <div className="card">
                  <div className="card-header">
                    <a href="about-us.html#collapse3-3" className="expand">
                      Sales Management
                    </a>
                  </div>
          ...
          <div className="row align-items-center mb-10">
            ...
            <div className="col-md-6 pl-lg-8 mb-8">
              ...
              <p className="mb-6">
                ...
                pretium lectus qua . Arpis massa. Nunc id cursus metus ididunt
                ut labore metus vulputate episcing.
              </p>
              <a href="about-us.html#" className="btn btn-dark btn-rounded">
                Visit Our Store
              </a>
            </div>
          </div>
      ...
      <section className="member-section mt-10 pt-9 mb-10 pb-4">
        <div className="container">
          ...
          <p className="text-center mb-8">
            Nunc id cursus metus aliquam. Libero id faucibus nisl tincidunt
            eget. Aliquam
            <br />
